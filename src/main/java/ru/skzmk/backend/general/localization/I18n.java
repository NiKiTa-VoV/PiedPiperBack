package ru.skzmk.backend.general.localization;

import lombok.extern.log4j.Log4j2;
import org.springframework.core.io.Resource;
import ru.skzmk.backend.general.localization.annotation.Localized;
import ru.skzmk.backend.general.localization.annotation.LocalizedField;
import ru.skzmk.backend.general.util.util.StringFormat;
import ru.skzmk.backend.general.util.util.reflection.ReflectionAnnotationUtil;
import ru.skzmk.backend.general.util.util.resource.ResourceUtil;
