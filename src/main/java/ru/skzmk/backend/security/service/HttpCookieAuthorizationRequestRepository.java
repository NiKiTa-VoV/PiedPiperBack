...
public class HttpCookieAuthorizationRequestRepository implements AuthorizationRequestRepository<OAuth2AuthorizationRequest> {
    ...
    public static final String REGISTRATION_PARAM_COOKIE_NAME = "registration";
    ...
    public void saveAuthorizationRequest(OAuth2AuthorizationRequest authorizationRequest, HttpServletRequest request, HttpServletResponse response) {
        ...
        saveLoginOrRegistration(authorizationRequest, request, response);
    }
    ...
    public void saveLoginOrRegistration(OAuth2AuthorizationRequest authorizationRequest, HttpServletRequest request, HttpServletResponse response) {
