package ru.piedpipers.backend.general.localization;

import lombok.extern.log4j.Log4j2;
import org.springframework.core.io.Resource;
import ru.piedpipers.backend.general.localization.annotation.Localized;
import ru.piedpipers.backend.general.localization.annotation.LocalizedField;
import ru.piedpipers.backend.general.util.util.reflection.ReflectionAnnotationUtil;
import ru.piedpipers.backend.general.util.util.resource.ResourceUtil;
import ru.piedpipers.backend.general.util.util.StringFormat;
...
public class I18n {
    ...
    private static void initLangs() {
        ...
        List<Resource> resources = ResourceUtil.getResources("schedule/lang", null);
