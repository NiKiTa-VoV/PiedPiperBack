...
import ru.piedpipers.backend.general.message.realization.user.auth.ApiResponse;
import ru.piedpipers.backend.general.message.realization.user.auth.AuthResponse;
import ru.piedpipers.backend.general.message.realization.user.auth.LoginRequest;
import ru.piedpipers.backend.security.data.UserPrincipal;
import ru.piedpipers.backend.security.service.TokenProvider;
import ru.piedpipers.backend.security.service.UserPrincipalCreator;
import ru.piedpipers.backend.util.exception.BadRequestException;
import ru.piedpipers.backend.general.message.realization.user.auth.SignUpRequest;
